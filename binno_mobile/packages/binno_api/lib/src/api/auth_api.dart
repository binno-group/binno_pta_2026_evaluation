...
class AuthApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AuthOtpRequestPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthOtpRequestPost200Response>> authOtpRequestPost({
    required AuthOtpRequestPostRequest authOtpRequestPostRequest,
    ...
    try {
      const _type = FullType(AuthOtpRequestPostRequest);
      _bodyData = _serializers.serialize(authOtpRequestPostRequest,
          specifiedType: _type);
    ...
    AuthOtpRequestPost200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AuthOtpRequestPost200Response),
            ) as AuthOtpRequestPost200Response;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<AuthOtpRequestPost200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthOtpVerifyPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthOtpVerifyPost200Response>> authOtpVerifyPost({
    required AuthOtpVerifyPostRequest authOtpVerifyPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AuthOtpVerifyPostRequest);
      _bodyData = _serializers.serialize(authOtpVerifyPostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    AuthOtpVerifyPost200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AuthOtpVerifyPost200Response),
            ) as AuthOtpVerifyPost200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<AuthOtpVerifyPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPair>> authRefreshPost({
