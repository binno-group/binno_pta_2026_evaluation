...
class CatalogApi {
  ...
  Future<Response<BuiltList<Category>>> categoriesTreeGet({
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductPage>> supplierProductsGet({
    String? status,
    String? cursor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/supplier/products';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> supplierProductsIdArchivePost({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/supplier/products/{id}/archive'.replaceAll(
        '{' r'id' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> supplierProductsIdPublishPost({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/supplier/products/{id}/publish'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SupplierProductsPost201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SupplierProductsPost201Response>> supplierProductsPost({
    ...
    SupplierProductsPost201Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SupplierProductsPost201Response),
            ) as SupplierProductsPost201Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<SupplierProductsPost201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
